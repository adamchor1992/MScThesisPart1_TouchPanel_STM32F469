...
Screen_Module2_SignalsView::Screen_Module2_SignalsView()
{
	...
	int bottom = Screen_Module2_GraphView::m_GraphRangeBottom; //make bottom value positive for sake of calculations
	...
	int top = Screen_Module2_GraphView::m_GraphRangeTop;
...
void Screen_Module2_SignalsView::setMinScrollWheelValues(int bottom)
{
	int rest = 0;
...
void Screen_Module2_SignalsView::setMaxScrollWheelValues(int top)
{
	int rest = 0;
